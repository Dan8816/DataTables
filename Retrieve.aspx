<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Retrieve.aspx.cs" Inherits="_Default" %>
    ...
    <nav class="navbar navbar-dark bg-dark" style="padding: 0px;">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <button class="btn btn-sm btn-outline-secondary" type="button"><a href="ShippingRequest.aspx">Make new Ship Request</a></button>
            </div>
        </div>
    </nav>
